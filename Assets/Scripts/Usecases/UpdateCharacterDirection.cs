...
namespace Usecases
{
    public class UpdateCharacterDirection : IUsecase<IUpdateCharacterDirectionCommand, ICharacterEntity>
    {
        ...
        public ICharacterEntity Execute(IUpdateCharacterDirectionCommand command)
        {
